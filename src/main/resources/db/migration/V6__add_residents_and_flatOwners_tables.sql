...
CREATE TABLE Mieszkania_wlascicieli
(
...
CREATE TABLE Wlasciciele_mieszkan
(
    Nr_mieszkanca CHAR(36)     NOT NULL,
    PESEL         Char(11),
...
ALTER TABLE Wlasciciele_mieszkan
...
CREATE INDEX IX_Mieszka ON Mieszkancy (Id_mieszkania)
/
